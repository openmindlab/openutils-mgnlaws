 ...
 * @author Sameer Charles $Id: ClasspathContentRepository.java 10433 2012-07-23 11:04:39Z fabian.necci $
 */
public final class ClasspathContentRepository
{
    ...
    public static Repository getRepository(String repositoryID)
    {
        ...
        if (repository == null)
        {
            ...
            if (repository == null)
            {
                final String s = "Failed to retrieve repository '"
                    + repositoryID
                    + "' (mapped as '"
                    + mappedRepositoryName
                    + "'). Your Magnolia instance might not have been initialized properly.";
                log.warn(s);
    ...
    public static Provider getRepositoryProvider(String repositoryID)
    {
        ...
        if (provider == null)
        {
            ...
            if (provider == null)
            {
                final String s = "Failed to retrieve repository provider '"
                    + repositoryID
                    + "' (mapped as '"
                    + mappedRepositoryName
                    + "'). Your Magnolia instance might not have been initialized properly.";
